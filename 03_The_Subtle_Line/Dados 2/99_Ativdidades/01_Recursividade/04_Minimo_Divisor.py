...
def minimoDivisorEntreDoisNumeros(numero1, numero2):
    ...
    if numero1 == 1 and numero2 == 1:
        ...
        return minimoDivisorEntreDoisNumeros(numero1, numero2)
...
print(
    f"O MMC entre {valor1} e {valor2} é: {minimoDivisorEntreDoisNumeros(valor1, valor2)}")

...
public class CartaoDeCredito {
	...
	public CartaoDeCredito(String numeroCartao, LocalDate dataDaquiTresAnos,double limite) {
	...
	public CartaoDeCredito(String numeroCartao, LocalDate dataDaquiTresAnos,double limite, String nomeAdicional) {
		this.numeroCartao = numeroCartao;
		this.dataValidade = dataDaquiTresAnos;
		this.limiteCredito = limite;
